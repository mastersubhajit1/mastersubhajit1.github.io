...
! function() {
    ...
    var e = window.document,
        ...
        g = function(e, t, o) {
            var r = function() {
                return u(e, t, r), o.apply(this, arguments)
            };
            h(e, t, r)
        },
        f = function(e, t, o) {
            var r = "readystatechange",
                a = function() {
                    if (t.test(e.readyState)) return u(e, r, a), o.apply(this, arguments)
                };
            h(e, r, a)
        },
        p = function(e) {
        ...
        y = function(e, t) {
            e = w(e).replace(/^octicon-/, ""), m(z, e) || (e = "mark-github");
        ...
        M = function(e, t) {
            ...
            if (!(o.push(t) > 1)) {
                ...
                if (c) {
                    var n = new a;
                    h(n, "abort", r), h(n, "error", r), h(n, "load", (function() {
                        var e;
                        try {
                    ...
                    h(l, "load", d), h(l, "error", d), l.readyState && f(l, /de|m/, d), i.document.getElementsByTagName("head")[0].appendChild(l)
                }
            }
        },
        F = function(e, t, o) {
            ...
            if (("." + h).substring(h.length - l.length) !== "." + l) return c.removeAttribute("href"), void o(d);
            var u = (" /" + c.pathname).split(/\/+/);
            if (((h === l || h === "gist." + l) && "archive" === u[3] || h === l && "releases" === u[3] && ("download" === u[4] || "latest" === u[4] && "download" === u[5]) || h === "codeload." + l) && (c.target = "_top"), "true" === w(t["data-show-count"]) && h === l && "marketplace" !== u[1] && "sponsors" !== u[1] && "orgs" !== u[1] && "users" !== u[1] && "-" !== u[1]) {
                var g, f;
                if (!u[2] && u[1]) f = "followers", g = "?tab=followers";
                else if (!u[3] && u[2]) f = "stargazers_count", g = "/stargazers";
                else if (u[4] || "subscription" !== u[3])
                    if (u[4] || "fork" !== u[3]) {
                        if ("issues" !== u[3]) return void o(d);
                        f = "open_issues_count", g = "/issues"
                    } else f = "forks_count", g = "/network/members";
                else f = "subscribers_count", g = "/watchers";
                var v = u[2] ? "/repos/" + u[1] + "/" + u[2] : "/users/" + u[1];
                M.call(this, "https://api.github.com" + v, (function(e, t) {
                    if (!e) {
                        var a = t[f];
                        d.appendChild(r("a", {
            ...
            if (null != t && null != r)
                if (t.getAttribute && (t = function(e) {
                    ...
                    var l = function() {
                        ...
                        u(n, "load", l), F.call(c, a, t, (function(e) {
                            var a = function(e) {
                                var t = e.offsetWidth,
                                    r = e.offsetHeight;
                            ...
                            n.parentNode.removeChild(n), g(n, "load", (function() {
                                E(n, a)
                    ...
                    h(n, "load", l), e.body.appendChild(n)
                }
        };
    t.protocol + "//" + t.host + t.pathname === i ? F(e.body, s(window.name || t.hash.replace(/^#/, "")), (function() {})) : function(t) {
        if ("complete" === e.readyState || "loading" !== e.readyState && !e.documentElement.doScroll) setTimeout(t);
        else if (e.addEventListener) {
            var o = b(t);
            g(e, "DOMContentLoaded", o), g(window, "load", o)
        } else f(e, /m/, t)
    }((function() {
